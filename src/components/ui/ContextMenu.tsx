                        ...
                        <div key={index}>
                            <button
                                ...
                                className={cn(
                                    ...
                                    action.variant === "cancel" && "mt-1 justify-center bg-zinc-100 font-semibold text-zinc-900 active:bg-zinc-200 dark:bg-zinc-800 dark:text-zinc-100 dark:active:bg-zinc-700",
                                )}
                            >
                            ...
                            {index < actions.length - 1 && action.variant !== "cancel" && actions[index + 1].variant !== "cancel" && (
