...
const GESTURE_TUTORIAL_KEY = "creatorops-gesture-tutorial-v2";
...
export function GestureTutorial() {
    ...
    useEffect(() => {
        const hasSeenTutorial =
            localStorage.getItem(GESTURE_TUTORIAL_KEY) ??
            localStorage.getItem("hasSeenGestureTutorial") ??
            localStorage.getItem("creatorops-swipe-tutorial-v1");
        if (hasSeenTutorial && !localStorage.getItem(GESTURE_TUTORIAL_KEY)) {
                    ...
                    <div className="mt-4 flex flex-col items-center text-center">
                        ...
                        <div className="mt-8 flex w-full items-center justify-between gap-4">
                            ...
                            <div className="flex items-center gap-2">
                                <Button variant="ghost" onClick={handleDismiss} className="rounded-full px-4">
                                    Skip
                                </Button>
