...
Keep cuts fast every 2-3 seconds, show close-up b-roll during each feature point, and place your key verdict text on screen in the first 4 seconds for reel retention.`,
    placeholders: [
      { key: "product_name", label: "Product Name", example: "Nike Air Max DN" },
      { key: "testing_period", label: "Testing Period", example: "21 days" },
      { key: "target_user", label: "Target Viewer", example: "on-your-feet all day" },
      { key: "first_impression", label: "First Impression", example: "premium but lighter than expected" },
      ...
      { key: "feature_1", label: "Top Feature 1", example: "all-day cushioning" },
      { key: "feature_2", label: "Top Feature 2", example: "breathable upper" },
      { key: "feature_3", label: "Top Feature 3", example: "easy-to-clean finish" },
      { key: "drawback_1", label: "Drawback 1", example: "runs narrow in the toe box" },
      { key: "drawback_2", label: "Drawback 2", example: "limited color options" },
      { key: "value_verdict", label: "Value Verdict", example: "fair for the comfort level" },
      { key: "alternative_product", label: "Alternative Product", example: "Adidas Ultraboost Light" },
      { key: "buyer_priority", label: "Primary Buyer Priority", example: "comfort" },
      { key: "other_priority", label: "Secondary Buyer Priority", example: "minimal weight" },
...
Use chapter-like text cards every 10 seconds, pin the verdict in the top comment, and keep pacing conversational with one camera change before the 20-second mark to maintain short-form watch time.`,
    placeholders: [
      ...
      { key: "creator_profile", label: "Creator Profile", example: "solo travel vlogger" },
      ...
      { key: "best_surprise", label: "Best Surprise", example: "autofocus locked quickly" },
      { key: "main_concern", label: "Main Concern", example: "battery drained fast in 4K" },
      { key: "milestone_day", label: "Milestone Day", example: "3" },
      { key: "what_changed", label: "What Changed", example: "I switched to eco mode" },
      { key: "build_quality_score", label: "Build Quality Score", example: "8" },
      { key: "build_quality_reason", label: "Build Quality Reason", example: "solid body with responsive buttons" },
      { key: "usability_score", label: "Usability Score", example: "9" },
      { key: "usability_reason", label: "Usability Reason", example: "intuitive menu and flip screen" },
      { key: "results_score", label: "Results Score", example: "8" },
      { key: "results_reason", label: "Results Reason", example: "sharp footage with balanced color" },
      { key: "competitor_name", label: "Competitor Name", example: "Canon R50" },
      { key: "win_category", label: "Win Category", example: "autofocus speed" },
      { key: "loss_category", label: "Loss Category", example: "low-light noise" },
      { key: "final_verdict", label: "Final Verdict", example: "worth it for most new creators" },
      { key: "ideal_buyer", label: "Ideal Buyer", example: "shooting hybrid content weekly" },
      { key: "non_ideal_buyer", label: "Non-Ideal Buyer", example: "needing full-frame low light" },
...
Use satisfying audio layers for tape peel and box opening, add rapid text overlays for each item reveal, and place the biggest reaction clip in the first 2 seconds to boost TikTok completion rate.`,
    placeholders: [
      ...
      { key: "packaging_style", label: "Packaging Style", example: "minimal matte black box" },
      { key: "packaging_feel", label: "Packaging Feel", example: "luxury and sturdy" },
      { key: "packaging_detail", label: "Packaging Detail", example: "embossed logo and magnetic flap" },
      ...
      { key: "quality_check_result", label: "Quality Check", example: "no leaks, all seals intact" },
      { key: "finish_description", label: "Finish Description", example: "clean and premium" },
      { key: "sensory_note", label: "Sensory Note", example: "light citrus scent" },
      { key: "surprise_moment", label: "Surprise Moment", example: "a handwritten thank-you card" },
      ...
      { key: "first_test", label: "First Test", example: "swatch and texture test" },
      { key: "initial_verdict", label: "Initial Verdict", example: "promising and giftable" },
      { key: "comment_keyword", label: "Comment Keyword", example: "PART2" },
      { key: "store_name", label: "Store Name", example: "GlowLab online store" },
...
Use clear chapter timestamps, keep an overhead unboxing camera plus face-cam reaction, and include mid-roll recap graphics after each item segment so long-form viewers can rejoin context quickly.`,
    placeholders: [
      { key: "product_bundle_name", label: "Product Bundle Name", example: "Creator Desk Setup Kit" },
      { key: "brand_name", label: "Brand Name", example: "StudioForge" },
      { key: "shipping_condition", label: "Shipping Condition", example: "two days early with no dents" },
      { key: "outer_packaging_state", label: "Outer Packaging State", example: "clean and secure" },
      { key: "first_visual_detail", label: "First Visual Detail", example: "foam inserts around every component" },
      { key: "bundle_item_1", label: "Bundle Item 1", example: "USB-C microphone" },
      { key: "bundle_item_2", label: "Bundle Item 2", example: "adjustable arm stand" },
      { key: "bundle_item_3", label: "Bundle Item 3", example: "RGB key light" },
      { key: "bundle_item_4", label: "Bundle Item 4", example: "cable organizer pack" },
      ...
      { key: "setup_steps_summary", label: "Setup Steps Summary", example: "mount mic, balance arm, pair light" },
      { key: "setup_time", label: "Setup Time", example: "18 minutes" },
      { key: "setup_challenge", label: "Setup Challenge", example: "threading the arm cable clip" },
      { key: "first_use_test", label: "First Use Test", example: "recording a podcast intro" },
      { key: "first_use_result", label: "First Use Result", example: "clean audio with little background noise" },
      { key: "pro_1", label: "Pro 1", example: "excellent cable management" },
      { key: "pro_2", label: "Pro 2", example: "premium build for the price" },
      { key: "pro_3", label: "Pro 3", example: "quick setup once instructions are clear" },
      ...
      { key: "description_section_name", label: "Description Section", example: "Gear Links" },
    ],
  },
  {
...
Use large on-screen step numbers, keep each step under 12 seconds, add a progress bar at the top, and repeat the final result shot at the end for rewatch-driven saves on Instagram.`,
    placeholders: [
      { key: "problem_statement", label: "Problem Statement", example: "inconsistent lighting in reels" },
      { key: "step_count", label: "Step Count", example: "4" },
      { key: "desired_outcome", label: "Desired Outcome", example: "clean studio-quality videos" },
      { key: "step_1_title", label: "Step 1 Title", example: "Control Window Light" },
      { key: "step_1_action", label: "Step 1 Action", example: "face the window at a 45-degree angle" },
      { key: "step_1_mistake", label: "Step 1 Mistake", example: "placing window directly behind you" },
      { key: "step_1_fix", label: "Step 1 Fix", example: "rotate your desk and add a curtain diffuser" },
      { key: "step_2_title", label: "Step 2 Title", example: "Set White Balance" },
      { key: "step_2_action", label: "Step 2 Action", example: "lock white balance manually before recording" },
      { key: "step_2_success_signal", label: "Step 2 Success Signal", example: "skin tone stays consistent between cuts" },
      { key: "step_3_title", label: "Step 3 Title", example: "Dial Exposure" },
      { key: "step_3_action", label: "Step 3 Action", example: "lower exposure until highlights are preserved" },
      { key: "tool_name", label: "Tool Name", example: "Filmic Pro" },
      { key: "important_setting", label: "Important Setting", example: "ISO under 200" },
      { key: "step_4_title", label: "Step 4 Title", example: "Color Match Clips" },
      { key: "step_4_action", label: "Step 4 Action", example: "apply one LUT and adjust intensity to 60%" },
      { key: "quality_check_item", label: "Quality Check Item", example: "skin tone and shadow detail" },
      { key: "time_saved", label: "Time Saved", example: "30 minutes per shoot" },
      { key: "tool_cost_note", label: "Tool Cost Note", example: "all free except optional tripod" },
      { key: "ideal_user", label: "Ideal User", example: "solo creators filming at home" },
      { key: "non_ideal_user", label: "Non-Ideal User", example: "advanced multicam studio teams" },
      { key: "comment_keyword", label: "Comment Keyword", example: "CHECKLIST" },
      { key: "workflow_name", label: "Workflow Name", example: "lighting setup" },
    ],
  },
  {
...
Add clear chapters in the timeline, include zoom-ins during software steps, and restate outcomes every few minutes so long-form viewers stay oriented and keep average view duration high.`,
    placeholders: [
      { key: "goal_action", label: "Goal Action", example: "edit cinematic b-roll on your phone" },
      { key: "starting_point", label: "Starting Point", example: "mobile editing apps" },
      ...
      { key: "end_result", label: "End Result", example: "a polished 45-second reel" },
      { key: "setup_action", label: "Setup Action", example: "organizing clips into labeled bins" },
      { key: "required_tools", label: "Required Tools", example: "CapCut and a phone tripod" },
      { key: "optional_tools", label: "Optional Tools", example: "ND filter and external mic" },
      { key: "execution_action", label: "Execution Action", example: "syncing clips to beat markers" },
      { key: "common_error", label: "Common Error", example: "jump cuts that break continuity" },
      { key: "error_fix", label: "Error Fix", example: "insert a 0.3-second transition b-roll clip" },
      { key: "optimization_action", label: "Optimization Action", example: "compressing export settings for upload" },
      { key: "metric_name", label: "Metric Name", example: "retention at 15 seconds" },
      { key: "benchmark_value", label: "Benchmark Value", example: "above 65%" },
      { key: "personal_shortcut", label: "Personal Shortcut", example: "reusing a saved color preset" },
      { key: "pain_point", label: "Pain Point", example: "manual color correction" },
      { key: "time_saved_estimate", label: "Time Saved Estimate", example: "20 minutes" },
      { key: "checkpoint_task", label: "Checkpoint Task", example: "assembling your rough cut" },
      { key: "resource_location", label: "Resource Location", example: "the first link in description" },
      { key: "comment_keyword", label: "Comment Keyword", example: "PART2" },
      { key: "follow_up_topic", label: "Follow Up Topic", example: "advanced transitions" },
      { key: "content_pillar", label: "Content Pillar", example: "video editing" },
    ],
  },
  {
...
Keep disclosure visible at the top, show lifestyle footage over direct ad shots, and place branded product demo in the middle so the hook feels creator-first and native to Instagram reels.`,
    placeholders: [
      ...
      { key: "core_reason", label: "Core Reason", example: "it solved my afternoon energy crash" },
      { key: "product_name", label: "Product Name", example: "HydraFuel Electrolyte Mix" },
      { key: "creator_identity", label: "Creator Identity", example: "a fitness coach and busy parent" },
      { key: "audience_problem", label: "Audience Problem", example: "staying hydrated during long workdays" },
      { key: "routine_moment_1", label: "Routine Moment 1", example: "morning training" },
      { key: "routine_moment_2", label: "Routine Moment 2", example: "midday work block" },
      { key: "routine_moment_3", label: "Routine Moment 3", example: "evening walk" },
      { key: "benefit_1", label: "Benefit 1", example: "mixes quickly with no chalky texture" },
      { key: "benefit_2", label: "Benefit 2", example: "balanced flavor without extra sugar" },
      { key: "benefit_3", label: "Benefit 3", example: "easy single-serve packets" },
      { key: "disclosure_note", label: "Disclosure Note", example: "this is sponsored, but opinions are fully mine" },
      { key: "ideal_customer_profile", label: "Ideal Customer Profile", example: "active people who forget to hydrate" },
      { key: "non_ideal_profile", label: "Non-Ideal Profile", example: "sensitive to flavored drinks" },
      { key: "starter_recommendation", label: "Starter Recommendation", example: "the unflavored sample pack" },
      { key: "use_duration", label: "Use Duration", example: "three weeks" },
      { key: "result_statement", label: "Result Statement", example: "fewer afternoon headaches" },
      { key: "values_alignment", label: "Values Alignment", example: "transparent ingredients and practical pricing" },
...
Mention sponsorship in the first 5 seconds, use side-by-side before/after visuals around 20 seconds, and keep one clear takeaway sentence at the end so short-form viewers remember the value proposition.`,
    placeholders: [
      ...
      { key: "product_name", label: "Product Name", example: "DeskFlow Task Planner" },
      { key: "baseline_condition", label: "Baseline Condition", example: "missing deadlines twice a week" },
      { key: "test_duration", label: "Test Duration", example: "14 days" },
      { key: "usage_context_1", label: "Usage Context 1", example: "content planning" },
      { key: "usage_context_2", label: "Usage Context 2", example: "brand deliverable tracking" },
      { key: "week_1_result", label: "Week 1 Result", example: "tasks felt more organized" },
      { key: "week_2_result", label: "Week 2 Result", example: "zero missed due dates" },
      { key: "final_difference", label: "Final Difference", example: "better focus and fewer last-minute edits" },
      { key: "top_like_1", label: "Top Like 1", example: "clean weekly dashboard" },
      { key: "top_like_2", label: "Top Like 2", example: "easy recurring task setup" },
      { key: "top_like_3", label: "Top Like 3", example: "mobile reminders that actually help" },
      { key: "improvement_area", label: "Improvement Area", example: "more customization in calendar colors" },
      { key: "ideal_audience", label: "Ideal Audience", example: "creators managing multiple clients" },
      { key: "not_for_audience", label: "Not For Audience", example: "people who prefer paper systems" },
      { key: "channel_alignment_reason", label: "Channel Alignment", example: "my channel teaches sustainable creator workflows" },
      { key: "transparency_statement", label: "Transparency Statement", example: "sponsorship approved, script opinions are mine" },
      { key: "comment_keyword", label: "Comment Keyword", example: "SHEET" },
      { key: "discount_code", label: "Discount Code", example: "FLOW15" },
      { key: "discount_amount", label: "Discount Amount", example: "15%" },
      { key: "checkout_path", label: "Checkout Path", example: "the pinned comment link" },
    ],
  },
  {
...
Use quick montage clips with punchy transitions, overlay each phase with bold labels, and include one messy real-life moment to increase authenticity and connection on TikTok.`,
    placeholders: [
      ...
      { key: "production_window", label: "Production Window", example: "2-hour" },
      { key: "planning_tool", label: "Planning Tool", example: "Notion board" },
      { key: "planning_inputs", label: "Planning Inputs", example: "hook, key shots, and CTA" },
      { key: "planning_time", label: "Planning Time", example: "15 minutes" },
      { key: "camera_setup", label: "Camera Setup", example: "iPhone 15 Pro on tripod" },
      { key: "lighting_setup", label: "Lighting Setup", example: "window light plus softbox" },
      { key: "audio_setup", label: "Audio Setup", example: "wireless lav mic" },
      { key: "shooting_challenge", label: "Shooting Challenge", example: "harsh shadows near noon" },
      { key: "shooting_fix", label: "Shooting Fix", example: "moved setup and diffused window" },
      { key: "editing_tool", label: "Editing Tool", example: "CapCut" },
      { key: "edit_structure", label: "Edit Structure", example: "hook, proof, payoff" },
      { key: "editing_bottleneck", label: "Editing Bottleneck", example: "syncing captions manually" },
      { key: "caption_framework", label: "Caption Framework", example: "problem, promise, proof" },
      { key: "posting_time", label: "Posting Time", example: "7:30 PM" },
      { key: "audience_signal", label: "Audience Signal", example: "peak follower activity" },
      { key: "total_time", label: "Total Time", example: "1 hour 52 minutes" },
      { key: "deliverable_count", label: "Deliverable Count", example: "3 short videos" },
      { key: "budget_note", label: "Budget Note", example: "$300 total gear setup" },
      { key: "bts_lesson", label: "BTS Lesson", example: "pre-lighting saves more time than fast editing" },
...
Use timestamp overlays for each day segment, blend voiceover with ambient clips for realism, and keep one candid challenge moment to avoid over-polished vlog energy on Instagram.`,
    placeholders: [
      { key: "creator_role", label: "Creator Role", example: "full-time fashion creator" },
      { key: "daily_goal", label: "Daily Goal", example: "two paid posts and one organic reel" },
      { key: "morning_time", label: "Morning Time", example: "7:00 AM" },
      { key: "morning_routine_step_1", label: "Morning Routine Step 1", example: "30-minute walk" },
      { key: "morning_routine_step_2", label: "Morning Routine Step 2", example: "reviewing campaign brief" },
      { key: "morning_priority", label: "Morning Priority", example: "shooting first before meetings" },
      { key: "midday_time", label: "Midday Time", example: "12:30 PM" },
      { key: "midday_task_1", label: "Midday Task 1", example: "editing brand clips" },
      { key: "midday_task_2", label: "Midday Task 2", example: "client revision call" },
      { key: "unexpected_issue", label: "Unexpected Issue", example: "SD card corrupted one take" },
      { key: "adjustment_action", label: "Adjustment Action", example: "re-shot with backup camera angle" },
      { key: "afternoon_time", label: "Afternoon Time", example: "3:30 PM" },
      { key: "afternoon_task", label: "Afternoon Task", example: "batch filming try-on transitions" },
      { key: "energy_state", label: "Energy State", example: "dropping after lunch" },
      { key: "focus_strategy", label: "Focus Strategy", example: "25-minute sprint timer" },
      { key: "evening_time", label: "Evening Time", example: "7:00 PM" },
      { key: "evening_task_1", label: "Evening Task 1", example: "replying to brand emails" },
      { key: "evening_task_2", label: "Evening Task 2", example: "posting and community replies" },
      { key: "prep_action", label: "Prep Action", example: "laying out tomorrow's outfits" },
      { key: "biggest_win", label: "Biggest Win", example: "finished deliverables before deadline" },
      { key: "biggest_lesson", label: "Biggest Lesson", example: "always duplicate footage immediately" },
      { key: "output_summary", label: "Output Summary", example: "3 published pieces and 2 drafts" },
      { key: "declined_task", label: "Declined Task", example: "an extra same-day collab request" },
      { key: "mood_shift_moment", label: "Mood Shift Moment", example: "a quick walk between edits" },
...
Display both products side-by-side for each category, use bold on-screen score cards, and keep your final recommendation in one clean sentence for fast YouTube short-form clarity.`,
    placeholders: [
      ...
      { key: "test_environment_1", label: "Test Environment 1", example: "indoor studio" },
      { key: "test_environment_2", label: "Test Environment 2", example: "busy street" },
      { key: "a_performance_score", label: "A Performance Score", example: "9" },
      { key: "b_performance_score", label: "B Performance Score", example: "8" },
      { key: "performance_reason", label: "Performance Reason", example: "clearer noise handling in traffic" },
      { key: "a_usability_note", label: "A Usability Note", example: "easy pairing but more settings" },
      { key: "b_usability_note", label: "B Usability Note", example: "simpler setup for beginners" },
      { key: "price_a", label: "Price A", example: "$349" },
      { key: "price_b", label: "Price B", example: "$149" },
      { key: "value_winner", label: "Value Winner", example: "Rode Wireless ME" },
      { key: "value_use_case", label: "Value Use Case", example: "simple talking-head content" },
      { key: "beginner_pick", label: "Beginner Pick", example: "Rode Wireless ME" },
      { key: "advanced_pick", label: "Advanced Pick", example: "DJI Mic 2" },
      { key: "overall_pick", label: "Overall Pick", example: "DJI Mic 2 for most prosumers" },
      { key: "deal_breaker_note", label: "Deal Breaker Note", example: "check local warranty support first" },
...
Use large numbers on screen for each tip, keep each point under 7 seconds, and end with a quick visual proof clip so viewers trust the tips and complete the video on TikTok.`,
    placeholders: [
      ...
      { key: "tip_1_action", label: "Tip 1 Action", example: "remove every pause over 0.4 seconds" },
      { key: "tip_1_reason", label: "Tip 1 Reason", example: "keeps pace high from first second" },
      { key: "tip_1_common_miss", label: "Tip 1 Common Miss", example: "micro-pauses between captions" },
      { key: "tip_2_title", label: "Tip 2 Title", example: "Front-Load Value" },
      { key: "tip_2_action", label: "Tip 2 Action", example: "state the outcome before the process" },
      { key: "tip_2_use_case", label: "Tip 2 Use Case", example: "your niche is competitive" },
      { key: "tip_2_mistake", label: "Tip 2 Mistake", example: "starting with generic intro lines" },
      { key: "tip_3_title", label: "Tip 3 Title", example: "Use Pattern Interrupts" },
      { key: "tip_3_action", label: "Tip 3 Action", example: "switch angle or visual every 2-3 seconds" },
      { key: "tip_3_benchmark", label: "Tip 3 Benchmark", example: "70% retention at 5 seconds" },
      { key: "tip_3_adjustment", label: "Tip 3 Adjustment", example: "hook wording and first cut" },
      { key: "before_after_result", label: "Before/After Result", example: "avg watch time rose from 6s to 11s" },
      { key: "extra_time_required", label: "Extra Time Required", example: "under 5 minutes" },
      { key: "priority_tip", label: "Priority Tip", example: "Cut Dead Space" },
      { key: "testing_method", label: "Testing Method", example: "A/B testing hooks across 6 posts" },
      { key: "comment_keyword", label: "Comment Keyword", example: "PART2" },
    ],
  },
  {
...
Use emotional pacing with music rises per chapter, add text chapter titles for clarity, and include authentic archival footage/screenshots to strengthen trust across any platform format.`,
    placeholders: [
      { key: "starting_situation", label: "Starting Situation", example: "working full-time while posting at midnight" },
      { key: "current_situation", label: "Current Situation", example: "running my creator business full-time" },
      { key: "core_challenge", label: "Core Challenge", example: "burnout and inconsistent income" },
      { key: "failed_attempt_1", label: "Failed Attempt 1", example: "posting daily without strategy" },
      { key: "failed_attempt_2", label: "Failed Attempt 2", example: "copying trends outside my niche" },
      { key: "failure_reason", label: "Failure Reason", example: "I had no repeatable system" },
      { key: "turning_point_event", label: "Turning Point Event", example: "a client canceled a major deal" },
      { key: "critical_decision", label: "Critical Decision", example: "rebuild from audience problems first" },
      { key: "new_process", label: "New Process", example: "weekly content pillars and batch production" },
      { key: "commitment_period", label: "Commitment Period", example: "90 days" },
      { key: "tracking_metric_1", label: "Tracking Metric 1", example: "save rate" },
      { key: "tracking_metric_2", label: "Tracking Metric 2", example: "qualified inbound leads" },
      { key: "result_timeline", label: "Result Timeline", example: "four months" },
      { key: "key_result", label: "Key Result", example: "tripled monthly brand revenue" },
      { key: "unexpected_benefit", label: "Unexpected Benefit", example: "less stress and better creative focus" },
      { key: "audience_current_state", label: "Audience Current State", example: "stuck in random posting mode" },
      { key: "core_advice", label: "Core Advice", example: "build one system before chasing growth hacks" },
      { key: "first_action_step", label: "First Action Step", example: "define one clear weekly content goal" },
      { key: "major_mistake_to_avoid", label: "Mistake To Avoid", example: "measuring only vanity metrics" },
      { key: "comment_keyword", label: "Comment Keyword", example: "FRAMEWORK" },
    ],
  },
  {
...
Use one clear diagram or on-screen visual metaphor, keep language jargon-free, and restate the key takeaway in the final 5 seconds to maximize educational retention in short-form YouTube.`,
    placeholders: [
      { key: "concept_name", label: "Concept Name", example: "audience retention" },
      { key: "negative_outcome", label: "Negative Outcome", example: "consistent reach" },
      { key: "simple_definition", label: "Simple Definition", example: "how long people keep watching your content" },
      { key: "context_trigger", label: "Context Trigger", example: "your first 3 seconds are weak" },
      { key: "impact_area_1", label: "Impact Area 1", example: "algorithm distribution" },
      { key: "impact_area_2", label: "Impact Area 2", example: "conversion quality" },
      { key: "example_scenario", label: "Example Scenario", example: "you start with a long intro" },
      { key: "bad_practice", label: "Bad Practice", example: "saving value for the end" },
      { key: "bad_result", label: "Bad Result", example: "viewers swipe in under 2 seconds" },
      { key: "good_practice", label: "Good Practice", example: "lead with a specific promise" },
      { key: "good_result", label: "Good Result", example: "higher watch-through and more saves" },
      { key: "framework_name", label: "Framework Name", example: "HPP Framework" },
      { key: "framework_step_1", label: "Framework Step 1", example: "hook with a specific promise" },
      { key: "framework_step_2", label: "Framework Step 2", example: "prove with one clear example" },
      { key: "framework_step_3", label: "Framework Step 3", example: "prompt one focused next step" },
      { key: "rule_1", label: "Rule 1", example: "state the payoff early" },
      { key: "rule_2", label: "Rule 2", example: "remove dead space between points" },
      { key: "rule_3", label: "Rule 3", example: "use proof before opinion" },
      { key: "common_myth", label: "Common Myth", example: "longer videos always hurt retention" },
      { key: "myth_reality", label: "Myth Reality", example: "structure matters more than raw length" },
      { key: "today_action_step", label: "Today Action Step", example: "rewrite your next hook with a measurable promise" },
      { key: "expected_timeline", label: "Expected Timeline", example: "1-2 weeks" },
      { key: "tracking_signal", label: "Tracking Signal", example: "average view duration" },
      { key: "comment_keyword", label: "Comment Keyword", example: "CHEATSHEET" },
      { key: "education_topic", label: "Education Topic", example: "creator growth strategy" },
    ],
  },
  {
...
Use concise sentence overlays with high contrast, keep one point per shot, and end with a recap card listing the three actions to encourage saves and shares on Instagram.`,
    placeholders: [
      ...
      { key: "target_outcome", label: "Target Outcome", example: "engagement quality" },
      { key: "time_needed", label: "Time Needed", example: "five minutes" },
      { key: "core_idea", label: "Core Idea", example: "lead captions with a specific reader identity" },
      { key: "common_reason_people_fail", label: "Why People Fail", example: "they open with generic statements" },
      { key: "urgency_reason", label: "Urgency Reason", example: "competition for attention is highest in the first line" },
      { key: "action_1", label: "Action 1", example: "name your audience in line one" },
      { key: "action_2", label: "Action 2", example: "state a concrete pain point" },
      { key: "action_3", label: "Action 3", example: "end with one clear response prompt" },
      { key: "example_context", label: "Example Context", example: "a fitness motivation reel" },
      { key: "specific_change", label: "Specific Change", example: "replaced a broad intro with athlete-specific language" },
      { key: "example_result", label: "Example Result", example: "comment quality improved within 24 hours" },
      { key: "edge_case_condition", label: "Edge Case Condition", example: "your niche is highly technical" },
      { key: "edge_case_adjustment", label: "Edge Case Adjustment", example: "define one key term before the tip" },
      { key: "main_mistake_to_avoid", label: "Main Mistake", example: "asking multiple CTAs in one caption" },
      { key: "quality_check_step", label: "Quality Check Step", example: "read the caption out loud in 15 seconds" },
      { key: "advanced_pairing_tip", label: "Advanced Pairing Tip", example: "a pinned comment with one clarifying example" },
      { key: "comment_keyword", label: "Comment Keyword", example: "BREAKDOWN" },
    ],
  },
];
